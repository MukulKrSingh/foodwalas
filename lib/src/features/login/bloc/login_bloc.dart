...
//   })  : _authenticationRepository = authenticationRepository,
//         super(const LoginState()) {
//     on<LoginUsernameChanged>((event, emit) => _onUsernameChanged);
//     on<LoginPasswordChanged>((event, emit) => _onPasswordChanged);
//     on<LoginSubmitted>((event, emit) => _onSubmitted);
//   }
